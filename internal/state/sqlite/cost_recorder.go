...
// NewCostRecorder wraps a SessionCostStore in the CostRecorder adapter.
// Table may be nil to use the baked-in default price sheet.
func NewCostRecorder(store *SessionCostStore, table pricing.Table) *CostRecorder {
